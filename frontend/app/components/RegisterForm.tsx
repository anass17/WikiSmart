  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-blue-900 via-blue-800 to-blue-700 p-4">
      ...
      >
        ...
        {
          status.type == "success" && (
            <p className="w-full bg-green-200 text-slate-700 font-semibold p-3 rounded-md border-green-500 mb-5 -mt-5 text-center">
              {status.message}
            </p>
          )
        }
        ...
        {
          status.type == "error" && (
            <p className="w-full bg-red-200 text-slate-700 font-semibold p-3 rounded-md border-red-500 mb-5 -mt-5 text-center">
              {status.message}
            </p>
          )
        }
